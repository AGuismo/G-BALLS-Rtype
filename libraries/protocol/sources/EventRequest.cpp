...
EventRequest::EventRequest(Ruint8 event, Ruint8 param, requestCode::sessionID session): AGameRequest(requestCode::game::EVENT, session), _event(event), _param(param)
{
}
