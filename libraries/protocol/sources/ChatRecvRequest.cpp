...
ChatRecvRequest::ChatRecvRequest() : ARequest(rtype::protocol::requestCode::chat::RECV_MSG)
{
}

ChatRecvRequest::ChatRecvRequest(const std::string &msg) : ARequest(rtype::protocol::requestCode::chat::RECV_MSG)
{
  _msg = msg;
}
...
ChatRecvRequest::ChatRecvRequest(ChatRecvRequest const& src) : ARequest(rtype::protocol::requestCode::chat::RECV_MSG)
{
  _msg = src._msg;
}
