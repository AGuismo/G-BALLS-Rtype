...
ObjectMover		*EntityFactory::createObject(const Entity::type &type, unsigned short id, const Position &pos)
{
...
//const Animation		EntityFactory::getAnimation(const Entity::type &t) const
//{
//	Animation		anim(t);
